...
@php
    ...
    $title = $dece->nom. ' '.$dece->prenom. " Ajouter plus de  photos :: ". $setting->name_entreprise;
    $title2 = $dece->nom. ' '.$dece->prenom. " Ajouter plus de  photos";
@endphp
@push("body")
    ...
    <div class="app-wrapper">
      ...
      <main class="app-main">
        ...
        <div class="app-content">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            @livewire("admin.dece-photos",["dece"=>$dece,"page"=>request()->fullUrl(),"allPhotos"=>$allPhotos])
            <!--end::Row-->
          </div>
          <!--end::Container-->
        </div>
