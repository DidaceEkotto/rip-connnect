...
@php
    ...
    $title = $produit->name.  " - Modifier le produit :: ". $setting->name_entreprise;
    $title2 = $produit->name. " - Modifier le produit";
@endphp
@push("body")
    ...
    <div class="app-wrapper">
      ...
      <main class="app-main">
        ...
        <div class="app-content">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            @livewire("admin.edite-produit", ['productId' => $produit->id, 'page' => request()->fullUrl()])
            <!--end::Row-->
          </div>
          <!--end::Container-->
        </div>
