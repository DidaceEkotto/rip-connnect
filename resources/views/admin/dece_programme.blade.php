...
@php
    ...
    $title = $dece->nom. ' '. $dece->prenom.  " - Programme :: ". $setting->name_entreprise;
    $title2 = $dece->nom. ' '. $dece->prenom.  " - Programme";
@endphp
@push("body")
    ...
    <div class="app-wrapper">
      ...
      <main class="app-main">
        ...
        <div class="app-content">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            @livewire("admin.programme-obsecque",["dece" => $dece, 'title'=>$title2, 'page'=>request()->fullUrl()])
            <!--end::Row-->
          </div>
          <!--end::Container-->
        </div>
