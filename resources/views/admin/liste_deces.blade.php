...
@php
    ...
    $title = "Liste des décès :: ". $setting->name_entreprise;
    $title2 = "Liste des décès ";
@endphp
@push("body")
          ...
          <div class="container-fluid">
            ...
            <div class="">
                        <div class="row row-deck row-cards">
                            ...
                            <div class="">
                                <div class="btn-list">
                                    <a href="{{ route('admin.dece.ajouter_dece') }}"
                                        ...
                                        Ajouter un avis et décé
                                    </a>
                                </div>
                            </div>
                            <p style="clear: both !important;"></p>
                            <br><br>
                            @livewire('admin.dece-list',['page'=>request()->fullUrl(), "deces"=>$deces])
