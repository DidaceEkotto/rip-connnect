...
@php
    ...
    $title = $dece->nom. ' '. $dece->prenom.  " - modification :: ". $setting->name_entreprise;
    $title2 = $dece->nom. ' '. $dece->prenom;
@endphp
@push("body")
    ...
    <div class="app-wrapper">
      ...
      <main class="app-main">
        ...
        <div class="app-content">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            @livewire("admin.edite-dece",["dece" => $dece, 'title'=>$title2, 'page'=>request()->fullUrl()])
            <!--end::Row-->
          </div>
          <!--end::Container-->
        </div>
