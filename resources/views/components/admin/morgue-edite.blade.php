...
new class extends Component
{
   ...
   public function mount($page,$morgue)
   {
        $this->page = $page;
        $this->morgue = $morgue;
        $this->nom = $this->morgue->nom;
        $this->logo_show  = $this->morgue->logo;
        $this->telephone = $this->morgue->telephone;
        $this->adresse = $this->morgue->adresse;
        $this->ville = $this->morgue->ville_id;
        $this->longitude = $this->morgue->longitude;
        $this->latitude = $this->morgue->latitude;
        $this->heure_ouverture = $this->morgue->heure_ouverture;
        $this->heure_fermeture = $this->morgue->heure_fermeture;
        $this->content = $this->morgue->description;
   ...
   public function saveMorgue()
   {
        $this->validate([
            "nom"=>"required|min:2",
            "logo"=>"nullable|image|mimes:png,webp,jpeg,jpg|max:2999",
        ...
        $this->morgue->update([
           ...
           "logo" =>$image != null ? "storage/images/{$image_name}" : $this->morgue->logo,
        ...
        return redirect()->route('admin.morgues.index')->with("success", "Morgue modifier avec succès");
   }
};
?>
                            ...
                            <div class="">
                                ...
                                <div class="mb-4">
                                    ...
                                    <span wire:loading.remove wire:target="saveMorgue">
                                        <i class="bi bi-check-circle me-1"></i>Modifier la morgue
                                    </span>
